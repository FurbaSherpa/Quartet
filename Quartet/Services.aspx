...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container box">
        <div class="intro column is-6 is-offset-3 has-text-centered">
          <h2 class="title has-text-info is-size-2">Heres what we have to offer!</h2><br>
          <p class="subtitle has-text-black">Vel fringilla est ullamcorper eget nulla facilisi. Nulla facilisi nullam vehicula ipsum a. Neque egestas congue quisque egestas diam in arcu cursus.</p>
        </div>
    </div>
